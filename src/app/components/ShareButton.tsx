  ...
  return (
    <div className="relative">
      <button
        ...
        className="btn btn-special group relative"
        aria-label="Share"
      >
      ...
      {!useNativeShare && showOptions && (
        <div className="absolute right-0 mt-2 w-48 bg-white dark:bg-amoled-card rounded-xl shadow-lg z-10 p-2 border border-gray-100 dark:border-amoled-border">
          <div className="py-1 grid gap-1">
            <button
              onClick={() => handleShare('twitter')}
              className="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-amoled-gray rounded-lg transition-all duration-200"
            >
